...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_09596967ba5612763644e04ee3345d4926d6b4df0a45b7d9870f6691a012a730');
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.admin_secured_area' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/admin/'))), $this->get('debug.event_dispatcher'));
    }

    /**
     * Gets the public 'security.firewall.map.context.admin_secured_area' shared service.
     *
    ...
    protected function getSecurity_Firewall_Map_Context_AdminSecuredAreaService()
    {
        ...
        $g = new \Symfony\Component\Security\Http\EntryPoint\BasicAuthenticationEntryPoint('Secured Admin Area');

        return $this->services['security.firewall.map.context.admin_secured_area'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($f, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('security.user.provider.concrete.in_memory')), 'admin_secured_area', $a, $this->get('debug.event_dispatcher', ContainerInterface::NULL_ON_INVALID_REFERENCE)), 2 => new \Symfony\Component\Security\Http\Firewall\BasicAuthenticationListener($b, $c, 'admin_secured_area', $g, $a), 3 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $f, $c)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), new \Symfony\Component\Security\Http\HttpUtils($d, $d, '{^https?://%s$}i'), 'admin_secured_area', $g, NULL, NULL, $a, false), NULL);
    }
    ...
    protected function getSwiftmailer_Mailer_Default_TransportService()
    {
        ...
        $a->setUsername('shionn35@gmail.com');
        $a->setPassword('shionn35');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin(array(0 => 'shionn35@gmail.com'), array());
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('security.user.provider.concrete.in_memory'), new \Symfony\Component\Security\Core\User\UserChecker(), 'admin_secured_area', $this->get('security.encoder_factory'), true)), true);
    ...
    {
        return $this->services['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(array('admin' => array('password' => '$2y$13$75NBIGpGKOQQyKU4eN62k.ZDNdoPHZRoBDurgDL9x8pnPEtUWHdeW', 'roles' => array(0 => 'ROLE_ADMIN'))));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'mailer_host' => NULL,
            'mailer_user' => 'shionn35@gmail.com',
            'mailer_password' => 'shionn35',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'shionn35@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'shionn35',
            ...
            'swiftmailer.mailer.default.single_address' => 'shionn35@gmail.com',
            'swiftmailer.mailer.default.delivery_addresses' => array(
                0 => 'shionn35@gmail.com',
            ),
            ...
            'swiftmailer.single_address' => 'shionn35@gmail.com',
